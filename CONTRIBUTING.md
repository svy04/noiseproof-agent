...
5. `docs/review/workflow-proof-bundle-runtime-smoke.md`
   ...
   - provider smoke packet: `docs/review/embedding-model-live-provider-owner-runtime-smoke-packet.md`; request refresh: `docs/review/external-reviewer-embedding-provider-owner-runtime-smoke-packet-request-refresh.md`; `api_calls_attempted: false`, `openai_api_key_printed: false`, not live embedding generation proof, hosted deployment evidence, external reviewer feedback, or product-complete.
