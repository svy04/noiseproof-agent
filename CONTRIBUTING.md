...
5. `docs/review/workflow-proof-bundle-runtime-smoke.md`
   ...
   - provider smoke packet: `docs/review/embedding-model-live-provider-owner-runtime-smoke-packet.md`; validator: `docs/review/embedding-model-live-provider-owner-runtime-smoke-validator.md`; post-run validation command: `docs/review/embedding-model-live-provider-owner-runtime-smoke-post-run-validation-command.md`; request refresh: `docs/review/external-reviewer-embedding-provider-owner-runtime-smoke-packet-request-refresh.md`; validator request refresh: `docs/review/external-reviewer-embedding-provider-owner-runtime-smoke-validator-request-refresh.md`; `api_calls_attempted: false`, `openai_api_key_printed: false`, not live embedding generation proof, hosted deployment evidence, external reviewer feedback, or product-complete.
