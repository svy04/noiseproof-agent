...
_GAP_ACTIONS = {
    "robust_pdf_extraction": {
        "acceptable_evidence": [
            ...
            "run a generalization gap review before any robust PDF extraction wording is allowed",
            ...
            "record an owner hold decision that blocks transcript text and hashes until source-rights response evidence exists",
        ...
        "proof_routes": [
            ...
            "docs/review/owner-approved-real-world-pdf-download-hash.md",
