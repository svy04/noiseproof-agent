...
Phase 33 adds workflow row links in `GET /ops/dashboard` to both `GET /workflow-runs/{id}` and `GET /workflow-runs/{id}/lineage`. It does not add dashboard polish, a frontend framework, or new lineage storage.
