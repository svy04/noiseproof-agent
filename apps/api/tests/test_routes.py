...
def test_ops_summary_and_dashboard_surface_current_proof_gap_registry():
    ...
    assert by_id["robust_pdf_extraction"]["current_evidence"] == (
        ...
        "_plus_source_policy_no_native_text_ocr_rights_request_delivery_record_v0"
    )
...
def test_ops_proof_gap_action_surface_exposes_gap_details_without_closing_gap():
    ...
    assert "docs/review/source-policy-pdf-parse-observation.md" in robust_gap[
        "proof_routes"
    ]
    ...
    assert "docs/review/source-policy-pdf-quality-gap-review.md" in robust_gap[
        "proof_routes"
    ]
    assert "docs/evaluation/source-policy-pdf-quality-gap-review-report.md" in robust_gap[
        "proof_routes"
    ]
    ...
    assert "docs/review/real-world-ocr-evidence-gate.md" in robust_gap[
        "proof_routes"
    ]
    assert (
    ...
    assert "docs/review/real-world-layout-fidelity-evidence-gate.md" in robust_gap[
        "proof_routes"
    ]
    assert (
