...
def test_ops_summary_and_dashboard_surface_current_proof_gap_registry():
    ...
    assert by_id["robust_pdf_extraction"]["current_evidence"] == (
        "digital_pdf_text_diagnostics_plus_multi_fixture_gap_matrix_plus_missing_runtime_observation_pack_plus_ocr_layout_image_adapter_runtime_pack_plus_committed_ocr_layout_image_binary_fixture_provenance_plus_opt_in_ocr_adapter_runtime_smoke_harness_plus_owner_runtime_pymupdf_ocr_smoke_with_tessdata_plus_multi_fixture_ocr_adapter_eval_v0_plus_licensed_real_world_pdf_fixture_pack_v0_plus_owner_approved_real_world_pdf_download_and_hash_v0_plus_real_world_pdf_parse_observation_without_robust_claim_v0"
    )
...
def test_ops_proof_gap_action_surface_exposes_gap_details_without_closing_gap():
    ...
    assert "docs/evaluation/live-lexical-qrels-baseline-report.md" in semantic_gap[
        "proof_routes"
    ]
    ...
    assert "docs/review/opt-in-ocr-adapter-owner-runtime-smoke.md" in robust_gap[
        "proof_routes"
    ]
    ...
    assert "docs/review/owner-approved-real-world-pdf-download-hash.md" in robust_gap[
        "proof_routes"
    ]
    assert (
    ...
    assert "docs/review/real-world-pdf-parse-observation.md" in robust_gap[
        "proof_routes"
    ]
    assert (
