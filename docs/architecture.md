...
- Workflow Proof Bundle Dashboard Link v0 exists: `GET /ops/dashboard` workflow rows link to the existing proof-bundle read model without adding endpoint behavior, storage, tracing, or dashboard polish.
