...
Previous operating gate: `source_policy_no_native_text_ocr_transcript_reference_pack_v0`.
...
Phase `real_world_pdf_fixture_source_policy_download_hash_v0` adds
`docs/review/source-policy-download-hash.md` and
`docs/evaluation/source-policy-download-hash-report.md`. Reproduce with:

```bash
cd apps/api
uv run python -m app.services.source_policy_download_hash_command \
  --manifest ../../examples/pdf-extraction-quality/source-policy-download-hash-observations.json \
  --output ../../docs/evaluation/source-policy-download-hash-report.md \
  --check
```

This is source-policy download/hash metadata only. It records
`download_hash_status -> passed_with_blocked_candidates`,
`downloaded_fixture_count -> 3`, `blocked_fixture_count -> 2`,
`external_route_count -> 1`, `binary_files_committed -> false`,
`download_cache_committed -> false`, `raw_text_committed -> false`,
`parser_calls_performed -> false`, `ocr_calls_performed -> false`,
...
Phase `source_policy_no_native_text_ocr_readiness_review_v0` adds
`docs/review/source-policy-no-native-text-ocr-readiness-review.md` and
`docs/evaluation/source-policy-no-native-text-ocr-readiness-review-report.md`.
Reproduce with:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_readiness_review_command \
  --review ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-readiness-review.json \
  --output ../../docs/evaluation/source-policy-no-native-text-ocr-readiness-review-report.md \
  --check
```

This is a source-policy no-native-text OCR readiness review only. It records
`readiness_status -> passed_with_conditions`, `fixture_id ->
nara_911_mfr_00282_no_native_text_candidate`,
`ocr_dependency_identified -> true`,
`ocr_dependency_runtime_check_performed -> false`,
`ocr_execution_performed -> false`, `ocr_quality_eval_performed -> false`,
...
Phase 897 adds external feedback current-state multi real-world PDF parse observation matrix issue verification remote verification v0: `docs/review/external-feedback-current-state-multi-real-world-pdf-parse-observation-matrix-issue-verification-remote-verification.md` records that head `084e3fe9fd3bf65bef873a28d7cbf8a06f3405ea` passed CI run `27497284929` job `81273628024` and External Feedback Screen run `27497284920` job `81273628056`, including `Check multi real-world PDF parse observation report staleness`, `Run API smoke tests`, and `Screen issue comments`. This is remote workflow verification only, not the current-state issue screen itself, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, or product-complete.

Phase 896 adds external feedback current-state multi real-world PDF parse observation matrix issue verification v0: `docs/review/external-feedback-current-state-multi-real-world-pdf-parse-observation-matrix-issue-verification.md` records that issue #1 now points to the multi real-world PDF matrix proof chain, but still has only one owner-authored comment. It keeps `comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, or product-complete.

Phase 895 adds external review issue body multi real-world PDF parse observation matrix route refresh v0: `docs/review/external-review-issue-body-multi-real-world-pdf-parse-observation-matrix-route-refresh.md` records the owner-authored issue #1 body update that routes `Latest Proof To Inspect` to `docs/review/multi-real-world-pdf-parse-observation.md`, `docs/review/multi-real-world-pdf-parse-observation-remote-verification.md`, `docs/review/external-reviewer-surfaces-multi-real-world-pdf-parse-observation-matrix-route-refresh.md`, and `docs/review/external-reviewer-surfaces-multi-real-world-pdf-parse-observation-matrix-route-refresh-remote-verification.md`. Observed markers: `updatedAt: 2026-06-14T11:19:43Z`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, and `has_multi_real_world_pdf_matrix_latest_proof: true`. This is owner-authored issue body routing only, not external reviewer feedback, hosted deployment evidence, robust PDF extraction evidence, or product-complete.

Phase 894 adds external reviewer surfaces multi real-world PDF parse observation matrix route refresh remote verification v0: `docs/review/external-reviewer-surfaces-multi-real-world-pdf-parse-observation-matrix-route-refresh-remote-verification.md` records that head `9952bbb9f14c60a7c5510fb50af49b03f485ca80` passed CI run `27496923203` job `81272609344` and External Feedback Screen run `27496923199` job `81272609334`, including `Check multi real-world PDF parse observation report staleness`, `Run API smoke tests`, and `Screen issue comments`. This is remote workflow verification only, not the route refresh itself, not robust PDF extraction evidence, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 893 adds external reviewer surfaces multi real-world PDF parse observation matrix route refresh v0: `docs/review/external-reviewer-surfaces-multi-real-world-pdf-parse-observation-matrix-route-refresh.md` records that `README.md`, `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-shortlist.md`, `docs/review/external-reviewer-link-map.md`, `CONTRIBUTING.md`, and `.github/ISSUE_TEMPLATE/external-review-feedback.md` route first-pass reviewers to `docs/review/multi-real-world-pdf-parse-observation.md` and `docs/review/multi-real-world-pdf-parse-observation-remote-verification.md`. It surfaces `observed_fixture_count -> 3`, head `a37fe32f0f46c5d04008ea425a053966f063950c`, CI run `27496475781`, and External Feedback Screen run `27496475772`. This is route hygiene only, not a live issue body edit, not new runtime evidence, not robust PDF extraction evidence, not hosted deployment evidence, not external reviewer feedback, and not product-complete.
...
Phase 890 adds real-world PDF parse observation remote verification v0: `docs/review/real-world-pdf-parse-observation-remote-verification.md` records that head `5d875a55e658593fde6ec31a4c34233a1a6e8d89` passed CI run `27495965671` job `81269970751` and External Feedback Screen run `27495965662`, including `Check real-world PDF parse observation report staleness` and `Run API smoke tests`. This is remote workflow verification only, not the owner-runtime parse observation itself, not robust PDF extraction evidence, hosted deployment evidence, external reviewer feedback, or product-complete.
...
Phase 888 adds owner-approved real-world PDF download/hash remote verification v0: `docs/review/owner-approved-real-world-pdf-download-hash-remote-verification.md` records that head `6d638fca11b02e03581a8296bb95bc9a5da3894c` passed CI run `27495693041` job `81269226120` and External Feedback Screen run `27495693049`, including `Check owner-approved real-world PDF download/hash report staleness` and `Run API smoke tests`. This is remote workflow verification only, not the owner-runtime download/hash observation itself, not robust PDF extraction evidence, hosted deployment evidence, external reviewer feedback, or product-complete.
...
Phase 871 adds multi-fixture PDF extraction quality eval remote verification v0: `docs/review/multi-fixture-pdf-extraction-quality-eval-remote-verification.md` records that head `0c9cf904fdb28f431338b683ded0d89d30fdbd88` passed CI run `27491985623` job `81258771544` and External Feedback Screen run `27491985622` job `81258771520`, including `Check multi-fixture PDF extraction quality report staleness` and `Run API smoke tests`. This is remote workflow verification only, not robust PDF extraction evidence, OCR evidence, layout fidelity evidence, hosted deployment evidence, external reviewer feedback, or product-complete.
...
```powershell
cd apps/api
uv run python -m app.services.live_semantic_qrels_baseline_command --fixture-root ../../examples/semantic-retrieval-quality --output ../../docs/evaluation/live-semantic-qrels-baseline-report.md --k 2 --check
uv run pytest tests/test_live_semantic_qrels_baseline.py -q
```

This is a caller-provided vector baseline over a tiny local fixture only, not semantic retrieval quality evidence, live embedding generation, representative retrieval evaluation, a benchmark result, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 863 adds live semantic qrels baseline eval remote verification v0: `docs/review/live-semantic-qrels-baseline-eval-remote-verification.md` records that head `ed73aef0b13261ac74ee14c7402d839dc5532797` passed CI run `27490045473` job `81253278484` and External Feedback Screen run `27490045474` job `81253278486`. This is remote workflow verification only, not semantic retrieval quality evidence, live embedding generation, representative retrieval evaluation, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 860 adds live lexical qrels baseline eval v0: `docs/review/live-lexical-qrels-baseline-eval.md` records that the existing local `retrieve_candidates()` lexical path can generate a qrels-evaluable run for the tiny semantic retrieval quality fixture. The committed report `docs/evaluation/live-lexical-qrels-baseline-report.md` records `run_source -> live_lexical_retrieve_candidates`, `retrieval_strategy -> fixed-window`, `judged_coverage_at_k -> 0.5714`, `unjudged_retrieved_count_at_k -> 3`, and `live_lexical_qrels_baseline_quality_claim_blocked`. CI checks it with `Check live lexical qrels baseline report staleness`. This is a live lexical baseline over a tiny local fixture only, not semantic retrieval quality evidence, embedding generation, representative retrieval evaluation, a benchmark result, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 861 adds live lexical qrels baseline eval remote verification v0: `docs/review/live-lexical-qrels-baseline-eval-remote-verification.md` records that head `8a7cc07aac8c4d7c218424a0ecf50381cfea0d3c` passed CI run `27489607815` job `81252099416` and External Feedback Screen run `27489607811` job `81252099394`. This is remote workflow verification only, not semantic retrieval quality evidence, embedding generation, representative retrieval evaluation, hosted deployment evidence, external reviewer feedback, or product-complete.
...
Phase 821 adds external feedback current-state uploaded PDF table adapter Noise Gate provenance issue verification remote verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-noise-gate-provenance-issue-verification-remote-verification.md` records remote workflow success on head `7af20f90c0c0350dc975de01ee4d48efffc3728a`: CI run `27078200661` (`api-smoke -> success`) and External Feedback Screen run `27078200654` (`screen -> success`). This is remote workflow evidence only, not the issue-state screen itself, not external reviewer feedback, not hosted deployment evidence, not customer validation, not Braincrew acceptance, not Noise Gate quality evidence, or product-complete.
...
Phase 828 adds external review issue body HTTP trace context Docker runtime smoke route refresh v0: `docs/review/external-review-issue-body-http-trace-context-docker-runtime-smoke-route-refresh.md` records the owner-authored issue #1 body update that routes `Latest Proof To Inspect` to the HTTP trace context Docker runtime smoke proof chain. Observed markers include `updatedAt: 2026-06-07T01:37:57Z`, `first_codepoint: 35`, `has_leading_bom: false`, `docs/review/http-trace-context-docker-runtime-smoke.md`, `docs/review/http-trace-context-docker-runtime-smoke-remote-verification.md`, and `old_uploaded_pdf_table_adapter_noise_gate_latest_label_present: false`. This is owner-authored issue routing only, not external reviewer feedback, hosted deployment evidence, distributed tracing, OpenTelemetry span export, hosted observability, or product-complete.
...
Phase 765 adds GOAL current-state Docker environment route refresh v0: `docs/review/goal-current-state-docker-environment-route-refresh.md` records that `docs/GOAL.md` now starts future agents from the upload PDF quality preview coverage-summary proof chain plus the Docker environment runtime proof route, including `Docker version 29.4.3`, `GET /health -> 200`, `GET /ops/summary -> 200`, `noiseproof-agent-api-1`, `noiseproof-agent-db-1`, and `noiseproof-agent-clamav`. This is GOAL navigation hygiene only, not new runtime evidence, hosted deployment evidence, production readiness, external reviewer feedback, or product-complete.

Phase 766 adds GOAL current-state Docker environment route refresh remote verification v0: `docs/review/goal-current-state-docker-environment-route-refresh-remote-verification.md` records that commit `3bcb0b5d43162c41347a9ced694bfe4d97e59a25` passed CI run `27070742785` and External Feedback Screen run `27070742798` after the Phase 765 GOAL overlay refresh was pushed. This is remote workflow verification only, not the GOAL overlay refresh itself, not new runtime evidence, hosted deployment evidence, production readiness, external reviewer feedback, or product-complete.

Phase 767 adds external review issue body Docker environment route refresh v0: `docs/review/external-review-issue-body-docker-environment-route-refresh.md` records the owner-authored issue #1 body update that points reviewers to the Docker environment runtime proof route, with `updatedAt: 2026-06-06T18:54:09Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `Docker version 29.4.3`, `GET /health -> 200`, `GET /ops/summary -> 200`, `noiseproof-agent-api-1`, `noiseproof-agent-db-1`, and `noiseproof-agent-clamav`. This is issue routing only, not new runtime evidence, hosted deployment evidence, production readiness, external reviewer feedback, or product-complete.

Phase 768 adds external review issue body Docker environment route refresh remote verification v0: `docs/review/external-review-issue-body-docker-environment-route-refresh-remote-verification.md` records that commit `fc54bf9de784e12104889020647bddab4a47c05f` passed CI run `27071038589` and External Feedback Screen run `27071038603` after the Phase 767 issue-body route refresh was pushed. This is remote workflow verification only, not the live issue body edit itself, not new runtime evidence, hosted deployment evidence, production readiness, external reviewer feedback, or product-complete.

Phase 769 adds external feedback current-state Docker environment issue verification v0: `docs/review/external-feedback-current-state-docker-environment-issue-verification.md` records the live issue #1 state after the Docker environment issue-body route refresh with `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `classification: non_qualifying`, `reason: self_authored_comment`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, production readiness, customer validation, Braincrew acceptance, or product-complete.

Phase 770 adds external feedback current-state Docker environment issue verification remote verification v0: `docs/review/external-feedback-current-state-docker-environment-issue-verification-remote-verification.md` records that commit `7aafcf7f45c7e5ec404b8b6bbe4b397c250be999` passed CI run `27071229045` and External Feedback Screen run `27071229043` after the Phase 769 issue-state screen was pushed. This is remote workflow verification only, not the current-state issue screen itself, not external reviewer feedback, hosted deployment evidence, production readiness, or product-complete.

Phase 771 adds PDF table extraction contract v0: `docs/review/pdf-table-extraction-contract.md` records the new `expected_table_rows` and `table_cell_recall` contract for the `table_heavy_report` PDF fixture. `packages/ingestion/pdf_quality/evaluator.py` now scores table cell recall separately from row count, and `docs/evaluation/pdf-extraction-quality-report.md` keeps the current table-heavy observation visible as `table_rows_extracted: 0` and `table_cell_recall: 0`. This is fixture/evaluator contract only, not robust PDF extraction implementation, OCR implementation, table extraction implementation, table extraction evidence, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 772 adds PDF table extraction adapter v0: `packages/ingestion/pdf_quality/table_adapter.py` adds a tiny PyMuPDF `Page.find_tables()` / `Table.extract()` adapter behind the Phase 771 contract, returning `tables`, `extracted_table_rows`, `table_rows_extracted`, `table_cell_count`, structured warnings, and `failure_case_candidate` fields with `table_extraction_engine -> pymupdf-find_tables-extract`. This is adapter output only, not wired into the default `PdfParser` output, not table extraction evidence for arbitrary market PDFs, not robust PDF extraction evidence, not OCR implementation, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 773 adds upload PDF quality preview table adapter v0: `POST /documents/upload-pdf-quality-preview` now returns `quality_table_adapter` from the Phase 772 PyMuPDF table adapter, exposing preview-only `table_extraction_engine -> pymupdf-find_tables-extract`, `extracted_table_rows`, `table_rows_extracted`, and `table_cell_count` while keeping `quality_observation.table_extraction_performed -> false` and `quality_summary.table_extraction_performed -> false`. This is preview-only adapter output, not default `PdfParser` table extraction, not table extraction evidence for arbitrary market PDFs, not robust PDF extraction evidence, not OCR implementation, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 774 adds upload PDF quality preview table adapter runtime smoke v0: `docs/review/upload-pdf-quality-preview-table-adapter-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase774` with `POSTGRES_PORT=55456`, `FastAPI URL: http://127.0.0.1:8117`, `GET /health -> 200`, `table_adapter_upload_status=200`, `quality_table_adapter_present=True`, `quality_table_adapter.table_extraction_engine=pymupdf-find_tables-extract`, `quality_table_adapter.table_rows_extracted=2`, `quality_table_adapter.table_cell_count=4`, `quality_table_adapter.rows=[['Segment', 'Growth'], ['Enterprise', '12%']]`, `quality_observation.table_extraction_performed=False`, `quality_summary.table_extraction_performed=False`, and `document_count_delta=0`. This is local runtime evidence only, not default `PdfParser` table extraction, not robust PDF extraction evidence, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 775 adds upload PDF quality preview table adapter runtime smoke remote verification v0: `docs/review/upload-pdf-quality-preview-table-adapter-runtime-smoke-remote-verification.md` records that commit `d7b87eabdbccfb80f88ed1f7980a44bc7e898b44` passed CI run `27072270531` and External Feedback Screen run `27072270526` after the Phase 774 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, not new runtime evidence, not default `PdfParser` table extraction, not robust PDF extraction evidence, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 776 adds PDF quality deterministic table adapter fixture v0: `docs/review/pdf-quality-deterministic-table-adapter-fixture.md` adds `deterministic_table_adapter_pdf` to the manifest/observation PDF quality fixture packet, regenerates `docs/evaluation/pdf-extraction-quality-report.md`, and records `deterministic_table_adapter_pdf | evaluated | 1 | 1 | 1 | 1` while keeping `table_heavy_report | evaluated | 1 | 0 | 1 | 1`. This is manifest/observation evaluator evidence only, not binary PDF fixture evidence, not default `PdfParser` table extraction, not robust PDF extraction evidence, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 777 adds PDF quality deterministic table adapter fixture remote verification v0: `docs/review/pdf-quality-deterministic-table-adapter-fixture-remote-verification.md` records that commit `e02d7595b08a17b8815780141515caaebe6fa36d` passed CI run `27072558017` and External Feedback Screen run `27072558020` after the Phase 776 fixture/report update was pushed. This is remote workflow verification only, not the fixture/report update itself, not new runtime evidence, not binary PDF fixture evidence, not default `PdfParser` table extraction, not robust PDF extraction evidence, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 778 adds PDF binary fixture provenance packet v0: `docs/review/pdf-binary-fixture-provenance-packet.md` adds synthetic binary PDF fixtures under `examples/pdf-extraction-quality/binary-fixtures/`, a `provenance.json` packet with SHA-256 and redistribution metadata, and `packages/ingestion/pdf_quality/binary_fixture.py` validation. This is synthetic binary fixture provenance only, not robust PDF extraction evidence, not default `PdfParser` table extraction, not external data redistribution, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 779 adds PDF binary fixture parser adapter smoke v0: `docs/review/pdf-binary-fixture-parser-adapter-smoke.md` and `packages/ingestion/pdf_quality/binary_smoke.py` run the synthetic binary PDF fixtures through `PdfParser` and the tiny PyMuPDF table adapter, recording `fixture_count -> 2`, `passed_count -> 2`, `failed_count -> 0`, `parser -> pdf-pymupdf`, `digital_pdf_text_extraction -> true`, and `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`. This is local parser/adapter smoke evidence over synthetic binary fixtures only, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 780 adds PDF binary fixture parser adapter smoke remote verification v0: `docs/review/pdf-binary-fixture-parser-adapter-smoke-remote-verification.md` records that commit `f3c123ec79c53832716cb79220488f5541bd5d2e` passed CI run `27072946995` and External Feedback Screen run `27072946997` after the Phase 779 parser/adapter smoke was pushed. This is remote workflow verification only, not the parser/adapter smoke itself, not new runtime evidence, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 781 adds external-reader proof path PDF binary fixture smoke route refresh v0: `docs/review/external-reader-proof-path-pdf-binary-fixture-smoke-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to the PDF binary fixture parser/adapter smoke and its remote verification. This is reviewer route hygiene only, not new runtime evidence, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 782 adds external-reader proof path PDF binary fixture smoke route refresh remote verification v0: `docs/review/external-reader-proof-path-pdf-binary-fixture-smoke-route-refresh-remote-verification.md` records that commit `5eeb09713302844de21fd3e8000704cc504aeeef` passed CI run `27073228784` and External Feedback Screen run `27073228781` after the Phase 781 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, not new runtime evidence, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 783 adds PDF binary fixture smoke preview runtime smoke v0: `GET /documents/pdf-binary-fixture-smoke-preview` exposes the repo synthetic binary fixture parser/adapter smoke through a preview-only API route. `docs/review/pdf-binary-fixture-smoke-preview-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase783` with `POSTGRES_PORT=55457`, `GET /health -> 200`, `GET /documents/pdf-binary-fixture-smoke-preview -> 200`, `fixture_count=2`, `passed_count=2`, `failed_count=0`, `document_count_delta=0`, and `agent_run_count=1`. This is local runtime evidence only, not arbitrary uploaded-file behavior, not document persistence evidence, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 784 adds PDF binary fixture smoke preview runtime smoke remote verification v0: `docs/review/pdf-binary-fixture-smoke-preview-runtime-smoke-remote-verification.md` records that commit `3ea288eef2f35d000db693ee003a509f156e8826` passed CI run `27073528326` and External Feedback Screen run `27073528323` after the Phase 783 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, not new runtime evidence, not arbitrary uploaded-file behavior, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 785 adds external-reader proof path PDF binary fixture smoke preview route refresh v0: `docs/review/external-reader-proof-path-pdf-binary-fixture-smoke-preview-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to the Phase 783/784 runtime proof chain for `GET /documents/pdf-binary-fixture-smoke-preview`. This is reviewer route hygiene only, not new runtime evidence, not arbitrary uploaded-file behavior, not document persistence evidence, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 786 adds external-reader proof path PDF binary fixture smoke preview route refresh remote verification v0: `docs/review/external-reader-proof-path-pdf-binary-fixture-smoke-preview-route-refresh-remote-verification.md` records that commit `6316eee78dc6a871c0be7e96df24af8b8281d02b` passed CI run `27073765424` and External Feedback Screen run `27073765431` after the Phase 785 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, not new runtime evidence, not arbitrary uploaded-file behavior, not robust PDF extraction evidence, not default `PdfParser` table extraction, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 787 adds external review issue body PDF binary fixture smoke preview route refresh v0: `docs/review/external-review-issue-body-pdf-binary-fixture-smoke-preview-route-refresh.md` records the owner-authored issue #1 body update that points `Latest Proof To Inspect` to the PDF binary fixture smoke preview runtime proof chain. Observed markers include `updatedAt: 2026-06-06T21:06:59Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `GET /documents/pdf-binary-fixture-smoke-preview`, `document_count_delta=0`, and `agent_run_count=1`. This is owner-authored issue body routing only, not external reviewer feedback, not new runtime evidence, not arbitrary uploaded-file behavior, not robust PDF extraction evidence, not hosted deployment evidence, and not product-complete.

Phase 788 adds external feedback current-state PDF binary fixture smoke preview issue verification v0: `docs/review/external-feedback-current-state-pdf-binary-fixture-smoke-preview-issue-verification.md` records that issue #1 currently routes to the PDF binary fixture smoke preview runtime proof path while the only screened comment is owner-authored, with `candidate_count: 0`, `classification: non_qualifying`, `reason: self_authored_comment_only`, and `status: pending`. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, or product-complete.

Phase 789 adds external feedback current-state PDF binary fixture smoke preview issue verification remote verification v0: `docs/review/external-feedback-current-state-pdf-binary-fixture-smoke-preview-issue-verification-remote-verification.md` records that commit `58da0ce51ffdc3a2de71d733974c78a1e29c3d3c` passed CI run `27074050121` and External Feedback Screen run `27074050119` after the Phase 788 issue-state screen was pushed. This is remote workflow verification only, not the issue-state screen itself, not external reviewer feedback, hosted deployment evidence, new runtime evidence, robust PDF extraction evidence, or product-complete.

Phase 790 adds PDF binary fixture smoke preview response contract v0: `GET /documents/pdf-binary-fixture-smoke-preview` now returns `reviewer_summary` and `response_contract` so the proof boundary is visible without digging through nested fixture data first. The response contract records `pdf_binary_fixture_smoke_preview_response_contract_v0`, `truth_scope: repo_synthetic_binary_fixture_smoke_only`, `document_count_delta: 0`, and `table_adapter_rows: [[Segment, Growth], [Enterprise, 12%]]`. This is response contract clarity only, not new runtime evidence, arbitrary uploaded-file behavior, robust PDF extraction evidence, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 791 adds PDF binary fixture smoke preview response contract runtime smoke v0: `docs/review/pdf-binary-fixture-smoke-preview-response-contract-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase791` with `POSTGRES_PORT=55458`, `FastAPI URL: http://127.0.0.1:8119`, `Pending migrations: 0`, `GET /health -> 200`, `GET /documents/pdf-binary-fixture-smoke-preview -> 200`, `reviewer_summary.api_surface=GET /documents/pdf-binary-fixture-smoke-preview`, `response_contract.contract=pdf_binary_fixture_smoke_preview_response_contract_v0`, `response_contract.truth_scope=repo_synthetic_binary_fixture_smoke_only`, `document_count_delta=0`, `agent_run_count_after=1`, and `table_adapter_rows=[[Segment, Growth], [Enterprise, 12%]]`. This is local runtime evidence only, not arbitrary uploaded-file behavior, not robust PDF extraction evidence, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 792 adds PDF binary fixture smoke preview response contract runtime smoke remote verification v0: `docs/review/pdf-binary-fixture-smoke-preview-response-contract-runtime-smoke-remote-verification.md` records that commit `43056ee9efa34448e82b90fc5287a328c6e0a643` passed CI run `27074533336` (`api-smoke -> success`, job `79909526986`) and External Feedback Screen run `27074533345` (`screen -> success`, job `79909526991`) after the Phase 791 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, not new runtime evidence, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 793 adds default PdfParser table adapter metadata v0: `packages/ingestion/parsers/pdf.py` now exposes the existing PyMuPDF table-adapter output in default `PdfParser` metadata when digital PDF table candidates are detected. The metadata includes `default_pdf_parser_table_adapter_metadata`, `table_adapter_boundary`, `table_adapter.table_extraction_engine=pymupdf-find_tables-extract`, and `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`, while `table_extraction_performed remains false` and `robust_pdf_extraction` remains false. See `docs/review/default-pdf-parser-table-adapter-metadata.md`. This is metadata visibility only, not robust PDF extraction evidence, OCR implementation, layout fidelity evidence, table extraction evidence for arbitrary market PDFs, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 794 adds default PdfParser table adapter metadata remote verification v0: `docs/review/default-pdf-parser-table-adapter-metadata-remote-verification.md` records that commit `996b9a4ff8ba13b99fd16e096758d287e7b084d3` passed CI run `27074818789` (`api-smoke -> success`, job `79910280094`) and External Feedback Screen run `27074818787` (`screen -> success`, job `79910280046`) after the Phase 793 product gate was pushed. This is remote workflow verification only, not the product gate itself, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 795 adds uploaded PDF table adapter metadata provenance v0: `POST /documents/upload-chunks` now preserves default `PdfParser` table-adapter metadata in `document.profile_json` and `chunk.metadata_json`, and `POST /documents/{document_id}/retrieval-runs` carries it into `retrieval_run.metadata_json` and retrieval results metadata. The regression test `test_uploaded_pdf_table_adapter_metadata_flows_into_chunk_and_retrieval_provenance` verifies `default_pdf_parser_table_adapter_metadata`, `table_adapter_boundary`, `table_adapter_extraction_performed`, and `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`, while `table_extraction_performed remains false`. See `docs/review/uploaded-pdf-table-adapter-metadata-provenance.md`. This is uploaded-PDF metadata provenance only, not robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 796 adds uploaded PDF table adapter metadata provenance remote verification v0: `docs/review/uploaded-pdf-table-adapter-metadata-provenance-remote-verification.md` records that commit `3b4d31b4052256c9c43fe7321d3502e05e3a1c7c` passed CI run `27075012127` (`api-smoke -> success`, job `79910781992`) and External Feedback Screen run `27075012138` (`screen -> success`, job `79910782010`) after the Phase 795 product gate was pushed. This is remote workflow verification only, not the product gate itself, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 797 adds uploaded PDF table adapter metadata provenance runtime smoke v0: `docs/review/uploaded-pdf-table-adapter-metadata-provenance-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase797` with `POSTGRES_PORT=55459`, `uv run uvicorn app.main:app --host 127.0.0.1 --port 8120`, `Pending migrations: 0`, `GET /health -> 200`, `POST /documents/upload-chunks -> 201`, `POST /documents/{document_id}/retrieval-runs -> 201`, `GET /retrieval-runs -> 200`, `document_profile_default_pdf_parser_table_adapter_metadata -> true`, `chunk_metadata_default_pdf_parser_table_adapter_metadata -> true`, `retrieval_metadata_default_pdf_parser_table_adapter_metadata -> true`, `retrieval_candidate_default_pdf_parser_table_adapter_metadata -> true`, `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`, `table_extraction_performed remains false`, and `all_required_markers_passed -> true`. This is local runtime evidence only, not hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, external reviewer feedback, or product-complete.

Phase 798 adds uploaded PDF table adapter metadata provenance runtime smoke remote verification v0: `docs/review/uploaded-pdf-table-adapter-metadata-provenance-runtime-smoke-remote-verification.md` records that commit `547b96103424730c8422562cfe77ada1c19e92f9` passed CI run `27075457410` (`api-smoke -> success`, job `79911954103`) and External Feedback Screen run `27075457400` (`screen -> success`) after the Phase 797 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, external reviewer feedback, or product-complete.

Phase 799 adds external-reader proof path uploaded PDF table adapter metadata provenance runtime route refresh v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-metadata-provenance-runtime-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to the Phase 795/796/797/798 uploaded PDF table-adapter metadata provenance proof chain, including `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `GET /retrieval-runs`, `default_pdf_parser_table_adapter_metadata`, `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`, `table_extraction_performed remains false`, and `source_provenance_boundary -> retrieval_run_candidate_chunk_metadata_only`. This is reviewer route hygiene only, not new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 800 adds external-reader proof path uploaded PDF table adapter metadata provenance runtime route refresh remote verification v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-metadata-provenance-runtime-route-refresh-remote-verification.md` records that commit `ddfec59770fc0f477e5329e74e9c06b4ab7bf694` passed CI run `27075715368` (`Run API smoke tests -> success`, job `79912654573`) and External Feedback Screen run `27075715366` (`Screen issue comments -> success`, job `79912654694`) after the Phase 799 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, external reviewer feedback, or product-complete.

Phase 801 adds external reviewer request brief outreach uploaded PDF table adapter metadata provenance runtime refresh v0: `docs/review/external-reviewer-request-brief-outreach-uploaded-pdf-table-adapter-metadata-provenance-runtime-refresh.md` routes `docs/review/external-review-request.md`, `docs/review/external-reviewer-brief.md`, and `docs/review/external-reviewer-outreach-packet.md` to the uploaded PDF table-adapter metadata provenance runtime proof chain, including `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `GET /retrieval-runs`, `default_pdf_parser_table_adapter_metadata`, `table_adapter.extracted_table_rows -> [[Segment, Growth], [Enterprise, 12%]]`, `table_extraction_performed remains false`, and `source_provenance_boundary -> retrieval_run_candidate_chunk_metadata_only`. This is reviewer navigation only, not new runtime evidence, live issue body edit, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, external reviewer feedback, or product-complete.

Phase 802 adds external review issue body uploaded PDF table adapter metadata provenance runtime route refresh v0: `docs/review/external-review-issue-body-uploaded-pdf-table-adapter-metadata-provenance-runtime-route-refresh.md` records the owner-authored issue #1 body update routing `Latest Proof To Inspect` to the uploaded PDF table-adapter metadata provenance runtime proof chain, with `updatedAt: 2026-06-06T22:45:17Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `old_pdf_binary_fixture_smoke_preview_latest_label_present: false`, `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, and `GET /retrieval-runs`. This is issue routing only, not external reviewer feedback, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, or product-complete.

Phase 803 adds external feedback current-state uploaded PDF table adapter metadata provenance issue verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-metadata-provenance-issue-verification.md` records that issue #1 still has `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `classification: non_qualifying`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true` after the Phase 802 issue-body route refresh. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, or product-complete.

Phase 804 adds external feedback current-state uploaded PDF table adapter metadata provenance issue verification remote verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-metadata-provenance-issue-verification-remote-verification.md` records that commit `5b885f4f7df626d19811d74a48a089a85f2f0166` passed CI run `27076150741` (`Run API smoke tests -> success`, job `79913777658`) and External Feedback Screen run `27076150731` (`Screen issue comments -> success`, job `79913777634`) after the Phase 803 issue-state screen was pushed. This is remote workflow verification only, not the issue-state screen itself, external reviewer feedback, hosted deployment evidence, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger generation, or product-complete.

Phase 805 adds uploaded PDF table adapter Evidence Ledger provenance v0: `docs/review/uploaded-pdf-table-adapter-evidence-ledger-provenance.md` records that bounded default `PdfParser` table-adapter metadata survives the uploaded-PDF chunk handoff, persisted document-chunk retrieval, and retrieval-run-linked Evidence Ledger persistence into stored Evidence Ledger row metadata. Smoke locally with `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger`, and `GET /evidence-ledgers?retrieval_run_id={retrieval_run_id}`. This is deterministic metadata provenance only, not robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, final truth adjudication, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 806 adds uploaded PDF table adapter Evidence Ledger provenance runtime smoke v0: `docs/review/uploaded-pdf-table-adapter-evidence-ledger-provenance-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase806` with `POSTGRES_PORT=55460`, `Pending migrations: 0`, `GET /health -> 200`, `POST /documents/upload-chunks -> 201`, `POST /documents/{document_id}/retrieval-runs -> 201`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger -> 201`, `GET /evidence-ledgers?retrieval_run_id={retrieval_run_id} -> 200`, `stored_entry_count -> 1`, `evidence_entry_default_pdf_parser_table_adapter_metadata -> True`, and `all_required_markers_passed -> True`. This is local runtime evidence only, not hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, final truth adjudication, external reviewer feedback, or product-complete.

Phase 807 adds uploaded PDF table adapter Evidence Ledger provenance runtime smoke remote verification v0: `docs/review/uploaded-pdf-table-adapter-evidence-ledger-provenance-runtime-smoke-remote-verification.md` records that commit `96967f9f00f43eb86c549df0adc1d3aca0f3cbb5` passed CI run `27076548950` (`Run API smoke tests -> success`, job `79914811968`) and External Feedback Screen run `27076548930` (`Screen issue comments -> success`, job `79914811952`) after the Phase 806 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, external reviewer feedback, or product-complete.

Phase 808 adds external-reader proof path uploaded PDF table adapter Evidence Ledger provenance runtime route refresh v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-evidence-ledger-provenance-runtime-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to the Phase 805/806/807 uploaded PDF table-adapter Evidence Ledger provenance proof chain, including `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger`, `GET /evidence-ledgers?retrieval_run_id={retrieval_run_id}`, `default_pdf_parser_table_adapter_metadata`, and `source_provenance_boundary -> evidence_ledger_entry_metadata_from_retrieval_run_candidate_chunk`. This is reviewer route hygiene only, not new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, final truth adjudication, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 809 adds external-reader proof path uploaded PDF table adapter Evidence Ledger provenance runtime route refresh remote verification v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-evidence-ledger-provenance-runtime-route-refresh-remote-verification.md` records that commit `7a2ce5ec113c9b1ab421a1bb30a6bb939a8069dc` passed CI run `27076749685` (`Run API smoke tests -> success`, job `79915329467`) and External Feedback Screen run `27076749689` (`Screen issue comments -> success`, job `79915329546`) after the Phase 808 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, external reviewer feedback, or product-complete.

Phase 810 adds external review issue body uploaded PDF table adapter Evidence Ledger provenance runtime route refresh v0: `docs/review/external-review-issue-body-uploaded-pdf-table-adapter-evidence-ledger-provenance-runtime-route-refresh.md` records the owner-authored issue #1 body update routing `Latest Proof To Inspect` to the uploaded PDF table-adapter Evidence Ledger provenance runtime proof chain, with `updatedAt: 2026-06-06T23:33:08Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `old_uploaded_pdf_table_adapter_metadata_latest_label_present: false`, `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger`, and `GET /evidence-ledgers?retrieval_run_id={retrieval_run_id}`. This is issue routing only, not external reviewer feedback, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, final truth adjudication, or product-complete.

Phase 811 adds external feedback current-state uploaded PDF table adapter Evidence Ledger provenance issue verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-evidence-ledger-provenance-issue-verification.md` records that after the Phase 810 issue-body route refresh, issue #1 still has `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `classification: non_qualifying`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, or product-complete.

Phase 812 adds external feedback current-state uploaded PDF table adapter Evidence Ledger provenance issue verification remote verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-evidence-ledger-provenance-issue-verification-remote-verification.md` records that commit `3a6d418dc3077401a536b435d0b0fcc184a011f0` passed CI run `27077127109` (`Run API smoke tests -> success`, job `79916310044`) and External Feedback Screen run `27077127096` (`Screen issue comments -> success`, job `79916309995`) after the Phase 811 issue-state screen was pushed. This is remote workflow verification only, not the issue-state screen itself, external reviewer feedback, hosted deployment evidence, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, or product-complete.

Phase 813 adds uploaded PDF table adapter Noise Gate provenance v0: `docs/review/uploaded-pdf-table-adapter-noise-gate-provenance.md` records that bounded uploaded-PDF table-adapter metadata preserved in persisted Evidence Ledger entry metadata now survives into retrieval-run-linked Noise Gate `stage_input_manifest`, including `default_pdf_parser_table_adapter_metadata`, `table_adapter.extracted_table_rows -> [['Segment', 'Growth'], ['Enterprise', '12%']]`, `source_pdf_table_adapter_provenance_boundary -> noise_gate_stage_input_manifest_from_evidence_ledger_entry_metadata`, and `handoff_performs_pdf_table_extraction -> false`. This is route-level regression evidence only, not local Docker runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Noise Gate quality evidence, final truth adjudication, final report generation, external reviewer feedback, or product-complete.

Phase 814 adds uploaded PDF table adapter Noise Gate provenance remote verification v0: `docs/review/uploaded-pdf-table-adapter-noise-gate-provenance-remote-verification.md` records that commit `a18fcc625bd533c56787911c64f03302ff606d9b` passed CI run `27077347774` (`Run API smoke tests -> success`, job `79916869573`) and External Feedback Screen run `27077347758` (`Screen issue comments -> success`, job `79916869639`) after the Phase 813 product gate was pushed. This is remote workflow verification only, not the product gate itself, local Docker runtime evidence, hosted deployment evidence, external reviewer feedback, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Noise Gate quality evidence, final truth adjudication, final report generation, or product-complete.

Phase 815 adds uploaded PDF table adapter Noise Gate provenance runtime smoke v0: `docs/review/uploaded-pdf-table-adapter-noise-gate-provenance-runtime-smoke.md` records local Docker PostgreSQL plus live FastAPI HTTP proof under `noiseproof-phase815` with `POSTGRES_PORT=55461`, `Pending migrations: 0`, `GET /health -> 200`, `POST /documents/upload-chunks -> 201`, `POST /documents/{document_id}/retrieval-runs -> 201`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger -> 201`, `POST /retrieval-runs/{retrieval_run_id}/noise-gate -> 201`, `GET /noise-gates -> 200`, `default_pdf_parser_table_adapter_metadata -> True`, `table_adapter.extracted_table_rows -> [['Segment', 'Growth'], ['Enterprise', '12%']]`, `table_extraction_performed -> False`, `source_pdf_table_adapter_provenance_boundary -> noise_gate_stage_input_manifest_from_evidence_ledger_entry_metadata`, `handoff_performs_pdf_table_extraction -> False`, and `all_required_markers_passed -> True`. This is local runtime evidence only, not hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Noise Gate quality evidence, final truth adjudication, final report generation, external reviewer feedback, or product-complete.

Phase 816 adds uploaded PDF table adapter Noise Gate provenance runtime smoke remote verification v0: `docs/review/uploaded-pdf-table-adapter-noise-gate-provenance-runtime-smoke-remote-verification.md` records that commit `69c35547866e4637a1a75c31c8989cd3ee10580c` passed CI run `27077666558` (`Run API smoke tests -> success`, job `79917692801`) and External Feedback Screen run `27077666546` (`Screen issue comments -> success`, job `79917692762`) after the Phase 815 runtime-smoke proof was pushed. This is remote workflow verification only, not the local runtime smoke itself, new runtime evidence, hosted deployment evidence, external reviewer feedback, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Noise Gate quality evidence, final truth adjudication, final report generation, or product-complete.

Phase 817 adds external-reader proof path uploaded PDF table adapter Noise Gate provenance runtime route refresh v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-noise-gate-provenance-runtime-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to the Phase 813/814/815/816 uploaded PDF table-adapter Noise Gate provenance proof chain, including `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger`, `POST /retrieval-runs/{retrieval_run_id}/noise-gate`, `GET /noise-gates`, `default_pdf_parser_table_adapter_metadata`, `table_adapter.extracted_table_rows -> [['Segment', 'Growth'], ['Enterprise', '12%']]`, `table_extraction_performed -> False`, `source_pdf_table_adapter_provenance_boundary -> noise_gate_stage_input_manifest_from_evidence_ledger_entry_metadata`, and `handoff_performs_pdf_table_extraction -> False`. This is reviewer route hygiene only, not new runtime evidence, live issue body edit, hosted deployment evidence, external reviewer feedback, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, Noise Gate quality evidence, final truth adjudication, final report generation, or product-complete.

Phase 818 adds external-reader proof path uploaded PDF table adapter Noise Gate provenance runtime route refresh remote verification v0: `docs/review/external-reader-proof-path-uploaded-pdf-table-adapter-noise-gate-provenance-runtime-route-refresh-remote-verification.md` records that commit `11c75de3b28c6ed5604fb61f9f31d37181c1f4aa` passed CI run `27077884275` (`Run API smoke tests -> success`, job `79918258737`) and External Feedback Screen run `27077884282` (`Screen issue comments -> success`, job `79918258752`) after the Phase 817 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, new runtime evidence, live issue body edit, hosted deployment evidence, external reviewer feedback, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, Noise Gate quality evidence, final truth adjudication, final report generation, or product-complete.

Phase 819 adds external review issue body uploaded PDF table adapter Noise Gate provenance runtime route refresh v0: `docs/review/external-review-issue-body-uploaded-pdf-table-adapter-noise-gate-provenance-runtime-route-refresh.md` records the owner-authored issue #1 body update routing `Latest Proof To Inspect` to the uploaded PDF table-adapter Noise Gate provenance runtime proof chain, with `updatedAt: 2026-06-07T00:29:26Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `old_uploaded_pdf_table_adapter_evidence_ledger_latest_label_present: false`, `POST /documents/upload-chunks`, `POST /documents/{document_id}/retrieval-runs`, `POST /retrieval-runs/{retrieval_run_id}/evidence-ledger`, `POST /retrieval-runs/{retrieval_run_id}/noise-gate`, and `GET /noise-gates`. This is owner-authored issue body routing only, not external reviewer feedback, new runtime evidence, hosted deployment evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Evidence Ledger quality evidence, Noise Gate quality evidence, final truth adjudication, final report generation, or product-complete.

Phase 820 adds external feedback current-state uploaded PDF table adapter Noise Gate provenance issue verification v0: `docs/review/external-feedback-current-state-uploaded-pdf-table-adapter-noise-gate-provenance-issue-verification.md` records that after the Phase 819 issue-body route refresh, issue #1 still has `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `classification: non_qualifying`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, hosted deployment evidence, customer validation, Braincrew acceptance, new runtime evidence, robust PDF extraction evidence, table extraction evidence for arbitrary market PDFs, Noise Gate quality evidence, or product-complete.

Phase 831 adds semantic retrieval quality diagnostic matrix v0: `docs/review/semantic-retrieval-quality-diagnostic-matrix.md` records that the toy semantic retrieval quality report now renders per-query diagnostic rows for semantic top-k ids, missed relevant chunks, missing information roles, missing embedding coverage, lexical rescue ids, and structured warnings including `no_semantic_candidates_at_k`. Regenerate with `uv run python -m app.services.semantic_quality_report_command --fixture ../../examples/semantic-retrieval-quality --rankings ../../examples/semantic-retrieval-quality/rankings.json --output ../../docs/evaluation/semantic-retrieval-quality-report.md --k 2`. This is toy fixture diagnostic evidence only, not vector search quality evidence, embedding generation, benchmark evidence, retrieval tuning, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 832 adds semantic retrieval quality diagnostic matrix remote verification v0: `docs/review/semantic-retrieval-quality-diagnostic-matrix-remote-verification.md` records that commit `e9458bfa079a9540476217160972a0374238ed57` passed CI run `27079764317` (`api-smoke -> success`, job `79923449359`) and External Feedback Screen run `27079764318` (`screen -> success`, job `79923449368`) after the Phase 831 diagnostic matrix gate was pushed. This is remote workflow verification only, not the diagnostic matrix itself, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, or product-complete.

Phase 833 adds external-reader proof path semantic retrieval quality diagnostic matrix route refresh v0: `docs/review/external-reader-proof-path-semantic-retrieval-quality-diagnostic-matrix-route-refresh.md` records that `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` now route reviewers to the semantic retrieval diagnostic matrix proof chain, including `q-what-missing`, `no_semantic_candidates_at_k`, and `lexical_retrieved_relevant_not_in_semantic_top_k`. This is route hygiene only, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, or product-complete.

Phase 834 adds external-reader proof path semantic retrieval quality diagnostic matrix route refresh remote verification v0: `docs/review/external-reader-proof-path-semantic-retrieval-quality-diagnostic-matrix-route-refresh-remote-verification.md` records that commit `5fbcb173306148f45f1eaa7c08ede8698294ce87` passed CI run `27079979229` (`api-smoke -> success`, job `79923997245`) and External Feedback Screen run `27079979254` (`screen -> success`, job `79923997313`) after the Phase 833 route refresh was pushed. This is remote workflow verification only, not the route refresh itself, not new runtime evidence, not vector search quality evidence, not hosted deployment evidence, not external reviewer feedback, or product-complete.

Phase 835 adds external review issue body semantic retrieval quality diagnostic matrix route refresh v0: `docs/review/external-review-issue-body-semantic-retrieval-quality-diagnostic-matrix-route-refresh.md` records the owner-authored issue #1 body update that points `Latest Proof To Inspect` to the semantic retrieval quality diagnostic matrix proof chain. It observed `updatedAt: 2026-06-07T02:15:43Z`, `first_codepoint: 35`, `has_leading_bom: false`, `has_semantic_diagnostic_latest_proof: true`, and `old_http_trace_context_latest_label_present: false`. This is issue routing only, not external reviewer feedback, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, or product-complete.

Phase 836 adds external feedback current-state semantic retrieval quality diagnostic matrix issue verification v0: `docs/review/external-feedback-current-state-semantic-retrieval-quality-diagnostic-matrix-issue-verification.md` records that after the semantic diagnostic issue-body route refresh, issue #1 still has `comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, not hosted deployment evidence, not customer validation, not Braincrew acceptance, not vector search quality evidence, not embedding generation, or product-complete.

Phase 837 adds external feedback current-state semantic retrieval quality diagnostic matrix issue verification remote verification v0: `docs/review/external-feedback-current-state-semantic-retrieval-quality-diagnostic-matrix-issue-verification-remote-verification.md` records that commit `aaa775e87bda75aa38137bf997f28e0368eaff4c` passed CI run `27080354999` (`api-smoke -> success`, job `79924961691`) and External Feedback Screen run `27080354996` (`screen -> success`, job `79924961645`) after the Phase 836 issue-state screen was pushed. This is remote workflow verification only, not the issue-state screen itself, not external reviewer feedback, not hosted deployment evidence, not customer validation, not Braincrew acceptance, or product-complete.

Phase 838 adds application-ready semantic diagnostic alignment v0: `docs/review/application-ready-semantic-diagnostic-alignment.md` records that `docs/review/application-ready-review.md` now points to the semantic diagnostic matrix, external-reader route refresh, issue-body route refresh, current-state issue screen, and remote verification chain while keeping `semantic retrieval quality remains unproven`, `candidate_count: 0`, and `status: pending` visible. This is application review alignment only, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 839 adds application-ready semantic diagnostic alignment remote verification v0: `docs/review/application-ready-semantic-diagnostic-alignment-remote-verification.md` records that commit `a105b45c0c56baf5da52cbacfa558662e372424e` passed CI run `27080545745` (`api-smoke -> success`, job `79925476229`) and External Feedback Screen run `27080545730` (`screen -> success`, job `79925476252`) after Phase 838 was pushed. This is remote workflow verification only, not the application alignment itself, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 840 adds semantic quality claim gate v0: `docs/review/semantic-quality-claim-gate.md` records that `packages/ingestion/retrieval/quality_metrics.py` now returns `claim_gate`, and `docs/evaluation/semantic-retrieval-quality-report.md` renders `## Quality Claim Gate` with `status: blocked`, `can_claim_semantic_quality: false`, and `semantic_quality_claim_blocked` for the toy fixture. This is claim blocking only, not vector search quality evidence, not embedding generation, not benchmark evidence, not retrieval tuning, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 841 adds semantic quality claim gate remote verification v0: `docs/review/semantic-quality-claim-gate-remote-verification.md` records that commit `c32186b7ce1e55ae45789ade8cd9000e84689ac8` passed CI run `27080779122` (`api-smoke -> success`, job `79926106355`) and External Feedback Screen run `27080779117` (`screen -> success`, job `79926106325`) after Phase 840 was pushed. This is remote workflow verification only, not the claim gate itself, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 842 adds external-reader proof path semantic quality claim gate route refresh v0: `docs/review/external-reader-proof-path-semantic-quality-claim-gate-route-refresh.md` records that `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` now route first-pass reviewers to the semantic quality claim gate, including `status: blocked`, `can_claim_semantic_quality: false`, `semantic_quality_claim_blocked`, and `claim_gate_only_not_vector_search_quality_evidence`. This is route hygiene only, not new runtime evidence, not vector search quality evidence, not embedding generation, not benchmark evidence, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 843 adds external-reader proof path semantic quality claim gate route refresh remote verification v0: `docs/review/external-reader-proof-path-semantic-quality-claim-gate-route-refresh-remote-verification.md` records that commit `2dd9bffda765bbdc5d718881b88213f54ad9bbc5` passed CI run `27081037580` (`api-smoke -> success`, job `79926796593`) and External Feedback Screen run `27081037566` (`screen -> success`, job `79926796612`) after Phase 842 was pushed. This is remote workflow verification only, not the route refresh itself, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.

Phase 844 adds external review issue body semantic quality claim gate route refresh v0: `docs/review/external-review-issue-body-semantic-quality-claim-gate-route-refresh.md` records the owner-authored issue #1 body update that points `Latest Proof To Inspect` to the semantic quality claim-gate proof chain. It observed `updatedAt: 2026-06-07T03:10:59Z`, `first_codepoint: 35`, `has_leading_bom: false`, `has_semantic_quality_claim_gate_latest_proof: true`, `has_semantic_quality_claim_gate_route_remote_verification: true`, and `old_semantic_diagnostic_latest_label_present: false`. This is issue routing only, not external reviewer feedback, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not customer validation, not Braincrew acceptance, or product-complete.

Phase 845 adds external review issue body semantic quality claim gate route refresh remote verification v0: `docs/review/external-review-issue-body-semantic-quality-claim-gate-route-refresh-remote-verification.md` records that commit `bb4ae002c4f0facf95481549ebf09b87dfa7ee36` passed CI run `27081249412` (`api-smoke -> success`, job `79927421314`) and External Feedback Screen run `27081249419` (`screen -> success`, job `79927421281`) after Phase 844 was pushed. This is remote workflow verification only, not the issue body route refresh itself, not external reviewer feedback, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not customer validation, not Braincrew acceptance, or product-complete.

Phase 846 adds external feedback current-state semantic quality claim gate issue verification v0: `docs/review/external-feedback-current-state-semantic-quality-claim-gate-issue-verification.md` records that after the semantic quality claim-gate issue-body route refresh, issue #1 still has `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true`. This is current-state issue screening only, not external reviewer feedback, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not customer validation, not Braincrew acceptance, or product-complete.

Phase 847 adds external feedback current-state semantic quality claim gate issue verification remote verification v0: `docs/review/external-feedback-current-state-semantic-quality-claim-gate-issue-verification-remote-verification.md` records that commit `6d29405bf8012e09d3257d1c4f440314e6e72754` passed CI run `27081453286` (`api-smoke -> success`, job `79928033772`) and External Feedback Screen run `27081453272` (`screen -> success`, job `79928033787`) after Phase 846 was pushed. This is remote workflow verification only, not the issue-state screen itself, not external reviewer feedback, not new runtime evidence, not vector search quality evidence, not embedding generation, not hosted deployment evidence, not customer validation, not Braincrew acceptance, or product-complete.

Phase 848 adds application-ready semantic quality claim gate alignment v0: `docs/review/application-ready-semantic-quality-claim-gate-alignment.md` records that `docs/review/application-ready-review.md` now points to the semantic quality claim-gate proof chain, including the claim gate, remote verification, external-reader route, issue-body route, current-state issue screen, and remote verification. It keeps `status: blocked`, `can_claim_semantic_quality: false`, `semantic_quality_claim_blocked`, `candidate_count: 0`, `status: pending`, and `semantic retrieval quality remains unproven` visible. This is application review alignment only, not vector search quality evidence, not embedding generation, not benchmark evidence, not retrieval tuning, not hosted deployment evidence, not external reviewer feedback, not customer validation, not Braincrew acceptance, or product-complete.
...
Phase 852 adds external-reader proof path local OTel span export runtime route refresh v0: `docs/review/external-reader-proof-path-local-otel-span-export-runtime-route-refresh.md` routes `docs/review/external-reader-proof-path.md`, `docs/review/external-reviewer-link-map.md`, and `docs/review/external-reviewer-shortlist.md` to `docs/review/local-otel-span-export.md` and `docs/review/local-otel-span-export-runtime-smoke.md`. It surfaces `NOISEPROOF_ENABLE_OTEL_SPAN_EXPORT=true`, `x-noiseproof-otel-span-export: local_in_memory_enabled`, `span_export_enabled=true`, `span_count=4`, and `local_in_memory_otel_span_export_not_distributed_tracing`. This is reviewer route hygiene only, not new runtime evidence, distributed tracing, hosted observability, external collector integration, OpenTelemetry Collector deployment, production monitoring, cross-service trace proof, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 853 adds external-reader proof path local OTel span export runtime route refresh remote verification v0: `docs/review/external-reader-proof-path-local-otel-span-export-runtime-route-refresh-remote-verification.md` records that commit `e749dd82a3f9c46a2a9ccac7a0ed6cf198627344` passed CI run `27488009359` (`api-smoke -> success`, job `81247794218`) and External Feedback Screen run `27488009357` (`screen -> success`, job `81247794249`) after Phase 852 was pushed. This is remote workflow verification only, not the route refresh itself, not new runtime evidence, distributed tracing, hosted observability, external collector integration, hosted deployment evidence, external reviewer feedback, or product-complete.

Phase 854 adds external review issue body local OTel span export runtime route refresh v0: `docs/review/external-review-issue-body-local-otel-span-export-runtime-route-refresh.md` records the owner-authored issue #1 body update that routes `Latest Proof To Inspect` to the local OTel span export runtime proof chain. Observed live issue markers: `updatedAt: 2026-06-14T04:23:17Z`, `comment_count: 1`, `starts_with_request: true`, `first_codepoint: 35`, `has_leading_bom: false`, `has_local_otel_latest_proof: true`, `has_local_otel_route_remote_verification: true`, and `old_semantic_quality_claim_gate_latest_label_present: false`. This is owner-authored issue body routing only, not external reviewer feedback, new runtime evidence, distributed tracing, hosted observability, external collector integration, hosted deployment evidence, customer validation, Braincrew acceptance, or product-complete.

Phase 855 adds external feedback current-state local OTel issue verification v0: `docs/review/external-feedback-current-state-local-otel-issue-verification.md` records that issue #1 still has `comment_count: 1`, `screened_comment_count: 1`, `owner_comment_count: 1`, `candidate_count: 0`, `draft_count: 0`, `reason: self_authored_comment_only`, `status: pending`, and `does_not_close_gate: true` after the local OTel issue-body route refresh. Keep reporting external reviewer feedback v0 as pending until a qualifying outside reviewer comment exists. This is current-state issue screening only, not external reviewer feedback, new runtime evidence, distributed tracing, hosted observability, external collector integration, hosted deployment evidence, customer validation, Braincrew acceptance, or product-complete.
...
Phase 879 adds opt-in OCR adapter runtime smoke remote verification v0: `docs/review/opt-in-ocr-adapter-runtime-smoke-remote-verification.md` records that commit `677a5b21803a506c3212ba91aa8046473d530034` passed CI run `27493543132` (`api-smoke -> success`, job `81263271845`) and External Feedback Screen run `27493543127` (`screen -> success`, job `81263271802`) after Phase 878 was pushed. This is remote workflow verification only, not OCR evidence, not robust PDF extraction evidence, not hosted deployment evidence, not external reviewer feedback, and not product-complete.

Phase 880 adds opt-in OCR adapter owner-runtime smoke v0: `docs/review/opt-in-ocr-adapter-owner-runtime-smoke.md` records one owner-runtime PyMuPDF OCR smoke over the committed synthetic image-only fixture. The accepted report kept `recognized_text -> ocr smoke text`, `expected_spans_found -> true`, `accepted_owner_runtime_smoke -> true`, `tessdata_path_printed -> false`, and `tessdata_path_committed_to_repo -> false`. This is one synthetic fixture OCR smoke only, not robust PDF extraction evidence, not arbitrary market PDF OCR evidence, not hosted deployment evidence, not external reviewer feedback, and not product-complete.
...
Phase 900 adds real-world layout fidelity evidence gate v0: `docs/review/real-world-layout-fidelity-evidence-gate.md` records one sanitized PyMuPDF block/bbox metadata sanity observation from a temporary owner-runtime BEA PDF download, regenerated into `docs/evaluation/real-world-layout-fidelity-evidence-gate-report.md`.
...
Phase `source_policy_no_native_text_ocr_quality_reference_pack_v0` records a
sanitized marker-anchor reference pack for the preserved NARA no-native-text
OCR route. It does not run OCR, compute CER/WER, commit reference transcripts,
or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_quality_reference_pack_command --reference-pack ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-quality-reference-pack.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-quality-reference-pack-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_quality_reference_pack.py -q
```

This is a marker-anchor reference pack only, not OCR quality evidence, not
...
Phase `source_policy_no_native_text_ocr_marker_proxy_eval_v0` records a bounded
marker-presence proxy eval for the preserved NARA no-native-text OCR route. It
uses committed marker-hit booleans only. It does not run OCR, inspect raw OCR
text, compute CER/WER, or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_marker_proxy_eval_command --marker-proxy-eval ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-marker-proxy-eval.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-marker-proxy-eval-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_marker_proxy_eval.py -q
```

This is a marker-presence proxy eval only, not OCR quality evidence, not
CER/WER support, not robust PDF extraction evidence, not arbitrary-market PDF
parsing evidence, not rendered visual fidelity evidence, not image/chart
interpretation evidence, not hosted deployment evidence, not external reviewer
feedback, and not product-complete. The next local product candidate is
`source_policy_no_native_text_ocr_transcript_reference_plan_v0`.

### Source-policy no-native-text OCR transcript reference plan

Phase `source_policy_no_native_text_ocr_transcript_reference_plan_v0` records a
source-policy-reviewed and owner-approval planning contract for the minimum
page-level transcript/reference boundary needed before OCR quality metrics can
be considered. It does not collect a transcript, run OCR, inspect raw OCR text,
compute CER/WER, or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_transcript_reference_plan_command --transcript-reference-plan ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-transcript-reference-plan.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-transcript-reference-plan-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_transcript_reference_plan.py -q
```

This is a transcript/reference planning contract only, not OCR quality
...
candidate is `source_policy_no_native_text_ocr_transcript_reference_pack_v0`.

### Source-policy no-native-text OCR transcript reference pack

Phase `source_policy_no_native_text_ocr_transcript_reference_pack_v0` records a
sanitized transcript-reference pack boundary for the preserved NARA
no-native-text OCR route. It does not collect a reference transcript, run OCR,
inspect raw OCR text, compute CER/WER, or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_transcript_reference_pack_command --transcript-reference-pack ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-transcript-reference-pack.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-transcript-reference-pack-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_transcript_reference_pack.py -q
```

This is a sanitized transcript-reference pack boundary only, not reference
...
Phase `source_policy_no_native_text_ocr_owner_transcript_collection_plan_v0`
records an owner-runtime transcript collection plan for the preserved NARA
no-native-text OCR route. It does not collect a reference transcript, record
source-rights approval as completed, commit transcript hashes, run OCR, inspect
raw OCR text, compute CER/WER, or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_owner_transcript_collection_plan_command --owner-transcript-collection-plan ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-owner-transcript-collection-plan.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-owner-transcript-collection-plan-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_owner_transcript_collection_plan.py -q
```

This is an owner-runtime transcript collection plan only, not transcript
collection evidence, not source-rights approval evidence, not reference
transcript availability, not OCR quality evidence, not CER/WER support, not
robust PDF extraction evidence, not arbitrary-market PDF parsing evidence, not
rendered visual fidelity evidence, not image/chart interpretation evidence, not
hosted deployment evidence, not external reviewer feedback, and not
...
Phase `source_policy_no_native_text_ocr_source_rights_review_request_packet_v0`
records a source-rights review request packet for the preserved NARA
no-native-text OCR route. It does not send the request, receive a rights
response, record source-rights owner approval, collect a reference transcript,
commit transcript text or hashes, compute CER/WER, or prove OCR quality.

Reproduce the report staleness check:

```bash
cd apps/api
uv run python -m app.services.source_policy_no_native_text_ocr_source_rights_review_request_packet_command --source-rights-review-request-packet ../../examples/pdf-extraction-quality/source-policy-no-native-text-ocr-source-rights-review-request-packet.json --output ../../docs/evaluation/source-policy-no-native-text-ocr-source-rights-review-request-packet-report.md --check
uv run pytest tests/test_source_policy_no_native_text_ocr_source_rights_review_request_packet.py -q
```

This is a source-rights review request packet only, not rights clearance
evidence, not request-sent evidence, not source-rights approval evidence, not
transcript collection evidence, not reference transcript availability, not OCR
