...
12. uploaded PDF retrieval-run provenance runtime proof:
...
13. uploaded PDF retrieval-run-linked Evidence Ledger provenance runtime proof:
...
14. uploaded-file chunk persistence proof:
...
15. uploaded-file chunk handoff proof:
