...
12. uploaded-file retrieval persistence proof:
...
13. retrieval-run-linked Evidence Ledger proof:
...
14. retrieval-run-linked Noise Gate proof:
...
17. uploaded raw file storage proof:
...
18. uploaded raw file scan result endpoint proof:
...
19. ClamAV adapter runtime smoke proof:
...
20. uploaded raw file scan execution endpoint runtime proof:
...
21. architecture current-state refresh:
