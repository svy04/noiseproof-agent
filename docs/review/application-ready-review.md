...
| direct stage-level input links exist | Partial / manifest only | workflow-created Noise Gate and Report rows include `stage_input_manifest` | JSON manifest only, not direct FK or join-table lineage |
