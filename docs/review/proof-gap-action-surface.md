...
After `source_policy_no_native_text_ocr_execution_plan_v0`, the action surface
includes:

```text
current_evidence -> ...plus_source_policy_no_native_text_ocr_execution_plan_v0
proof_routes -> docs/review/source-policy-no-native-text-ocr-execution-plan.md
proof_routes -> docs/evaluation/source-policy-no-native-text-ocr-execution-plan-report.md
recommended_next_gate -> source_policy_no_native_text_ocr_execution_smoke_v0
```

The execution plan defines an owner-runtime PyMuPDF/Tesseract OCR smoke
...
After `source_policy_no_native_text_ocr_quality_eval_plan_v0`, the action
surface includes:

```text
current_evidence -> ...plus_source_policy_no_native_text_ocr_quality_eval_plan_v0
proof_routes -> docs/review/source-policy-no-native-text-ocr-quality-eval-plan.md
proof_routes -> docs/evaluation/source-policy-no-native-text-ocr-quality-eval-plan-report.md
recommended_next_gate -> source_policy_no_native_text_ocr_quality_reference_pack_v0
```

The quality eval plan records the reference inputs and metric candidates needed
...
After `source_policy_no_native_text_ocr_transcript_reference_plan_v0`, the
action surface includes:

```text
current_evidence -> ...plus_source_policy_no_native_text_ocr_transcript_reference_plan_v0
proof_routes -> docs/review/source-policy-no-native-text-ocr-transcript-reference-plan.md
proof_routes -> docs/evaluation/source-policy-no-native-text-ocr-transcript-reference-plan-report.md
recommended_next_gate -> source_policy_no_native_text_ocr_transcript_reference_pack_v0
```

The transcript reference plan records the minimum source-policy-reviewed and
owner-approved reference boundary required before any true OCR quality metric
...
After `source_policy_no_native_text_ocr_source_rights_review_request_packet_v0`,
the action surface includes:

```text
current_evidence -> ...plus_source_policy_no_native_text_ocr_source_rights_review_request_packet_v0
proof_routes -> docs/review/source-policy-no-native-text-ocr-source-rights-review-request-packet.md
proof_routes -> docs/evaluation/source-policy-no-native-text-ocr-source-rights-review-request-packet-report.md
recommended_next_gate -> source_policy_no_native_text_ocr_owner_rights_decision_record_v0
```

The source rights review request packet records only the prepared request
questions, material scope, and repository non-commit policy. It is not rights
...
After `source_policy_no_native_text_ocr_rights_request_delivery_record_v0`,
the action surface includes:

```text
current_evidence -> ...plus_source_policy_no_native_text_ocr_rights_request_delivery_record_v0
proof_routes -> docs/review/source-policy-no-native-text-ocr-rights-request-delivery-record.md
proof_routes -> docs/evaluation/source-policy-no-native-text-ocr-rights-request-delivery-record-report.md
recommended_next_gate -> source_policy_no_native_text_ocr_owner_runtime_rights_request_delivery_v0
```

The rights request delivery record records only delivery route candidates and
missing owner-runtime delivery evidence. It is not rights clearance evidence,
not request-sent evidence, not request-delivery evidence, not source-rights
approval evidence, not source-rights owner decision evidence, does not evaluate
OCR quality, and does not close the robust-PDF gap.
