...
- Retrieval/semantic: Evidence/Gate/Report smokes; toy semantic retrieval quality report; caller-provided live semantic qrels baseline; representative local semantic quality fixture; owner-runtime qrels packet; no LLM, live embedding proof, public benchmark, or production quality.
