...
- Retrieval/semantic: Evidence/Gate/Report smokes; caller-provided embedding/retrieval persistence; toy semantic retrieval quality report; live lexical qrels baseline; caller-provided live semantic qrels baseline; no LLM, embedding generation, benchmark, representative or production quality.
