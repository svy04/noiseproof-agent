...
- Retrieval/semantic: Evidence/Gate/Report smokes; caller-provided embedding/retrieval persistence; toy semantic retrieval quality report; live lexical qrels baseline; caller-provided live semantic qrels baseline; representative local semantic quality fixture; no LLM, embedding generation, public benchmark, or production quality.
