...
| `docs/review/ci-node24-action-version-refresh.md` | workflow action references refreshed to upstream current major tags; remote annotation result remains unverified until the next push |
