...
- workflow direct stage links runtime smoke: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/workflow-direct-stage-links-runtime-smoke.md
  - Request refresh: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/external-reviewer-workflow-direct-stage-links-runtime-request-refresh.md
  - Boundary: local Docker PostgreSQL plus live FastAPI HTTP proof that workflow-created Evidence Ledger, Noise Gate, and Report records expose direct local links through `GET /workflow-runs/{id}/lineage` with `direct_stage_link_count: 3` and link types `evidence_to_report`, `evidence_to_noise_gate`, and `noise_gate_to_report`; not a live issue body edit, not external reviewer feedback, not hosted deployment evidence, not distributed tracing, not hosted observability, not autonomous workflow execution, and not product-complete.
- workflow stage event log runtime smoke: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/workflow-stage-event-log-runtime-smoke.md
  - Request refresh: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/external-reviewer-workflow-stage-event-log-runtime-request-refresh.md
  - Boundary: local Docker PostgreSQL plus live FastAPI HTTP proof that `POST /workflow-runs/execute-preview`, `GET /workflow-runs/{id}`, and `GET /workflow-runs/{id}/proof-bundle` expose local stage events with `detail_stage_event_count: 4`, `bundle_stage_event_count: 4`, and `local_workflow_stage_event_log_not_distributed_tracing`; not a live issue body edit, not external reviewer feedback, not hosted deployment evidence, not distributed tracing, not hosted observability, not autonomous workflow execution, and not product-complete.
- workflow failed stage event runtime smoke: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/workflow-failed-stage-event-runtime-smoke.md
  - Request refresh: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/external-reviewer-workflow-failed-stage-event-runtime-request-refresh.md
  - Boundary: local Docker PostgreSQL plus live FastAPI HTTP proof that `POST /workflow-runs/execute-preview -> 500` still leaves `retrieval -> completed`, `evidence_ledger -> failed`, `workflow_stage_event_count: 2`, and `failure_case_count_delta -> 0`; not a live issue body edit, not external reviewer feedback, not hosted deployment evidence, not retry behavior, not automatic failure-case creation, not distributed tracing, not hosted observability, and not product-complete.
- workflow failure auto-created failure-case runtime smoke: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/workflow-failure-auto-failure-case-creation-runtime-smoke.md
  - Request refresh: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/external-reviewer-workflow-failure-auto-creation-runtime-request-refresh.md
  - Boundary: local Docker PostgreSQL plus live FastAPI HTTP proof that `POST /workflow-runs/execute-preview -> 500` can create one linked local v0 failure case with `failure_case_count_delta -> 1`, `auto_failure_case_id`, `auto_created_from_workflow_failure_local_v0`, and `local_workflow_stage_failure_event_auto_failure_case_local_v0`; not a live issue body edit, not external reviewer feedback, not hosted deployment evidence, not retry behavior, not root-cause automation, not complete workflow failure causality, and not product-complete.
- workflow failure auto-created failure-case dashboard runtime proof: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/workflow-failure-auto-created-failure-case-dashboard-runtime-smoke.md
  - Request refresh: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/external-reviewer-workflow-failure-auto-created-dashboard-runtime-request-refresh.md
  - Boundary: local Docker PostgreSQL plus live FastAPI HTTP proof that `GET /ops/dashboard -> 200` surfaces the auto-created failure-case id, workflow parent link, and review queue linked count for a failed workflow; includes `dashboard_contains_auto_created_failure_case_id`, `dashboard_contains_workflow_parent_link`, and `dashboard_contains_review_queue_linked_count`; not a live issue body edit, not external reviewer feedback, not hosted deployment evidence, not retry behavior, not root-cause automation, not complete workflow failure causality, and not product-complete.
...
- persisted document failure candidate manual handoff runtime proof: https://github.com/svy04/noiseproof-agent/blob/main/docs/review/persisted-document-failure-candidate-manual-handoff-runtime-smoke.md
