...
After Workflow Lineage Warning Code Runbook Example v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- review whether warning codes should appear in the plain dashboard before adding UI behavior
