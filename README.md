...
Current operating gate: `source_policy_no_native_text_ocr_source_rights_review_request_packet_v0`.
...
| Next local product candidate | `source_policy_no_native_text_ocr_owner_rights_decision_record_v0` | Record the owner rights decision before any transcript text or hash can enter the repository. |
