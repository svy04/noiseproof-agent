...
| Next local product candidate | `cross_publisher_real_world_pdf_fixture_gate_v0` | Add source-policy-reviewed non-BEA real-world fixture coverage before stronger PDF claims. |
