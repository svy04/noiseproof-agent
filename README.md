...
- Next direction: Workflow stage input manifest v0
...
After Direct Evidence-to-gate/report Cross-link Review v0, the next phase should improve cross-stage lineage carefully without overstating the runtime:

- add a workflow stage input manifest so downstream stages can record persisted upstream ids they consumed
