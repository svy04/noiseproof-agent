...
| Next local product candidate | `source_policy_pdf_parse_quality_matrix_v0` | Turn the source-policy parse observations into a small quality matrix before any stronger parser wording. |
