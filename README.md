...
| Next local product candidate | `source_policy_pdf_quality_gap_review_v0` | Decide which blocked quality surface to attack next before any parser-quality wording changes. |
