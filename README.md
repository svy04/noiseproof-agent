...
Latest external-feedback state: pending after report markdown local inspection issue-body route refresh. The current issue screen has `candidate_count=0`, `draft_count=0`, and only a self-authored issue comment.
