...
After Direct Cross-stage Link Schema Review v0, the next phase should improve cross-stage lineage carefully without overstating the runtime:

- expose a derived workflow lineage read model from existing workflow child records and `stage_input_manifest`
