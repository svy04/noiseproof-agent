...
After Workflow Lineage Missing-reference Review v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- add a targeted missing-reference test around the derived lineage read model
