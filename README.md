...
After Workflow Lineage Warning Code Dashboard Review v0, the next phase should improve lineage inspectability carefully without overstating the runtime:

- surface warning codes in the plain dashboard only as bounded lineage-response hints
