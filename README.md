...
- Retrieval-run-linked ledger persistence, agent-run-linked gate records, persisted report records, embeddings, and semantic retrieval: not implemented
...
After Agent-run Linkage Review v0, the next phase should improve record linkage carefully without overstating the workflow:

- implement an agent-run lifecycle that creates the parent run before inserting child persisted records
