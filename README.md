...
After Workflow Lineage Warning Code Documentation Review v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- add a runbook lineage response example that shows both `warnings` and `warning_codes`
