...
After WorkflowRun Schema v0, the next phase should improve workflow lineage carefully without overstating the runtime:

- add minimal `workflow_runs` metadata persistence before any evidence -> gate -> report orchestration endpoint
