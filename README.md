...
| Next local product candidate | `source_policy_pdf_parse_observation_v0` | Parse only the source-policy-reviewed downloaded candidates enough to observe extraction behavior, while still avoiding robust-PDF wording. |
