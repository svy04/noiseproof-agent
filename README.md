...
After Workflow Lineage Warning Taxonomy Review v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- add structured warning categories only if they preserve the existing human-readable warnings
