...
After Single Workflow Parent Review v0, the next phase should improve workflow lineage carefully without overstating the runtime:

- add a minimal `workflow_runs` schema only if it stays local, deterministic, and inspectable
