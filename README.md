...
After WorkflowRun Child-link Review v0, the next phase should improve workflow lineage carefully without overstating the runtime:

- add a minimal workflow execution boundary before any child `workflow_run_id` schema changes
