...
Latest external-feedback state: pending after retrieval-run-linked Gate/Report semantic source provenance issue verification. The current issue screen has `candidate_count=0`, `draft_count=0`, and only a self-authored issue comment.
