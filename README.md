...
After WorkflowRun Metadata Persistence v0, the next phase should improve workflow lineage carefully without overstating the runtime:

- review whether the operations dashboard should surface `workflow_runs` before any evidence -> gate -> report orchestration endpoint
