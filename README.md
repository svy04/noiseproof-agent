...
After Workflow Stage Input Manifest v0, the next phase should improve cross-stage lineage carefully without overstating the runtime:

- review whether the manifest is enough to justify direct evidence -> gate -> report link columns or join tables
- keep lineage inspectable without introducing LLM calls, dashboard polish, semantic retrieval, or free-form answer generation
