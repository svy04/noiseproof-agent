...
After Workflow Lineage Boundary Hardening Review v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- harden manifest-shape parsing so non-list values cannot be treated as iterable evidence id lists
