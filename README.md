...
After WorkflowRun Child-record Links v0, the next phase should improve workflow inspectability carefully without overstating the runtime:

- add a workflow-run child inspection surface or review direct evidence -> gate -> report links
