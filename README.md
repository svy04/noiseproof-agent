...
After Workflow Lineage Missing-reference Test v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- review whether any additional lineage boundary hardening is needed before adding new schema
