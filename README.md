...
After Workflow Lineage Dashboard Links v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- add a small review or test around missing manifest references in the derived lineage read model
