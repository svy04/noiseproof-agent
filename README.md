...
After WorkflowRun Dashboard Table v0, the next phase should improve workflow lineage carefully without overstating the runtime:

- review whether child records should get nullable `workflow_run_id` links before any evidence -> gate -> report orchestration endpoint
