...
After Structured Warning Taxonomy v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- review warning-code documentation consistency before dashboard or schema expansion
