...
After Workflow Lineage Manifest-shape Hardening v0, the next phase should improve lineage confidence carefully without overstating the runtime:

- review warning taxonomy for lineage warnings before adding new warning fields or schema
