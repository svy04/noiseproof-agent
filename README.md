...
File upload preview v0 through external reviewer parsed-document persistence issue-body refresh v0 are now implemented as bounded upload proof steps. The current next evidence gate remains `external reviewer feedback v0`; external reviewer feedback is still pending.
