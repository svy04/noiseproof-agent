...
After Workflow Lineage Read Model v0, the next phase should improve workflow inspectability carefully without overstating the runtime:

- expose small dashboard or detail links to the derived workflow lineage endpoint
